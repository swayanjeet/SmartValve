...
urlpatterns = [
    ...
    url(r'^org_admins/update/(?P<pk>\d+)',
        login_required(Smart_Valve.OrgAdminViews.OrgAdminEditView.as_view()), name='org_admin_edit_view'),
    url(r'^org_admins/delete/(?P<pk>\d+)',
        login_required(Smart_Valve.OrgAdminViews.OrgAdminDeleteView.as_view()), name='org_admin_delete_view'),
    ...
    url(r'^user/update/(?P<pk>\d+)',
        login_required(Smart_Valve.UserViews.UserEditView.as_view()), name='user_edit_view'),
    url(r'^user/delete/(?P<pk>\d+)',
        login_required(Smart_Valve.UserViews.UserDeleteView.as_view()), name='user_delete_view'),
